...
- **[2024/03/12]** We have recently added a processed version of the ActivityNet-v1.3 to the folders, named `Anet_videos_15fps_short256.zip`. It contains all the videos in ActivityNet-v1.3, including 19,994 videos. The video has been converted by ffmpeg to 15 fps, and the shorter side of the video is resized to 256 pixels. The size of the zip file is 104.1GB.
